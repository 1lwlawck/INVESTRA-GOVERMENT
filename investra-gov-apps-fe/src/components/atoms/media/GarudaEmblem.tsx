...
export function GarudaEmblem({ className = '', size = 40 }: { className?: string; size?: number }) {
  return (
    ...
    >
      <path
        d="M60 15 L95 35 L95 75 L60 105 L25 75 L25 35 Z"
        fill="#C41E3A"
        stroke="#8B0000"
        strokeWidth="2"
      />
      ...
      <polygon
        points="60,22 63,30 72,30 65,35 68,43 60,38 52,43 55,35 48,30 57,30"
        fill="#F9B233"
        stroke="#CC8400"
        strokeWidth="0.5"
      />
      ...
      <path
        d="M55 105 L58 110 L60 105 L62 110 L64 105"
        stroke="#F9B233"
        strokeWidth="1.5"
        fill="none"
      />
      <path d="M30 95 Q60 88 90 95" fill="#FFFFFF" stroke="#333" strokeWidth="1" />
      <text x="60" y="98" textAnchor="middle" fontSize="5" fill="#333" fontWeight="bold">
